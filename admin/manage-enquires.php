...
<html>
<head>
<title>Dream Tour Sri Lanka Admin manage Bookings</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Manage reservation</li>
            </ol>
